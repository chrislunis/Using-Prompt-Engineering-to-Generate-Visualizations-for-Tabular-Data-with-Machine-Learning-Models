question_bank = {
    ...
    "StatisticalSummary": {
        "question": "Can you provide a statistical summary of the numeric columns in the data file, including mean, median, standard deviation, minimum, and maximum values in a table format?",
    ...
    "DisplayRelevantPlots": {
        "question": "Can you display relevant plots to help understand the data patterns and trends?",
        "response_format": "plot"
    },
    "RelationalDataOverview": {
        "question": "Can you provide an overview of the relationships between the sheets, including primary and foreign key relationships?",
        "response_format": "text"
    },
    "RelationalDataInsights": {
        "question": "What insights can be derived from the relationships between the different sheets in the file?",
        "response_format": "text"
    },
    "IdentifyFormatting": {
        "question": "Can you identify any conditional formatting, charts, or formula columns in the sheets?",
        "response_format": "text"
    },
    "ExplainFormatting": {
        "question": "Can you explain the purpose and effect of the identified formatting elements in the sheets?",
        "response_format": "text"
    }
}
